...
// and postorder traversals 
    ...
    /* Recursive function to construct binary of size n 
       ...
       do not form a tree */
    Util.Node buildUtil(int in[], int post[], int inStrt,
        ...
        Util.Node node = new Util.Node(post[pIndex.index]);
        (pIndex.index)--;
    ...
    // and calls buildUtil() 
    Util.Node buildTree(int in[], int post[], int n) {
    ...
    public static void main(String[] args) {
        BinaryTreeFromPostIn tree = new BinaryTreeFromPostIn();
        int in[] = new int[]{4, 8, 2, 5, 1, 6, 3, 7};
        int post[] = new int[]{8, 4, 5, 2, 6, 7, 3, 1};
        int n = in.length;
        Util.Node root = tree.buildTree(in, post, n);
